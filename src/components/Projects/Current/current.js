...
const Future = () =>  {
  ...
  const projects = [ 
    ...
    {name : "Chess Engine", description : "A chess engine using the Minimax Algorithm to determine the best moves", pic : NA, link : "https://github.com/TAwc/ChessEngine", techs : ["Chess","Multi-threading","C++","Python"]}],
    ]
