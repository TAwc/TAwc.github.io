...
const Past = () =>  {
    ...
    const projects = [ 
                      ...
                      [ {name : "Campus-AStar-pathing", description : "A very simple node based path finding algorithm for my college campus", pic : ASimg, link : "https://github.com/TAwc/Campus-AStar-pathing", techs : ["Processings", "A*"]}, 
                        {name : "Nerual Network Lib", description : "A long working project, a custom nerual network Library to help me understand them better", pic : NNimg, link : "https://github.com/TAwc/NeuralNetworkLib", techs : ["Python","Nerual Networks", "Tensorflow", "Numpy"]}],
